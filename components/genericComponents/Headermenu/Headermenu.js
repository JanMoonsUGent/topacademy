					...
					<li className={css["main-header__expanded-nav-item--home"]} key="mainlogo">
						<a href="/">
							<div className={css["main-header__nav-home-container"]}>
								<img src="/images/logo/logowithtext1.svg" alt="logo" className={css["main-header__nav-home-logo"]} />
								<img src="/images/logo/logowithtext1.svg" alt="logo" className={css["main-header__nav-home-logo--mobile"]} />
							</div>
						</a>
					</li>
